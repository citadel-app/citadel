...
export const CodeStatusWidget = () => {
    ...
    const refreshDockerContainers = useCallback(async () => {
        ...
        try {
            const containers = await __hostApi.module.invoke('@citadel-app/code', 'repl:list-containers');
    ...
    const handleStopDockerContainer = async (id: string) => {
        try {
            await __hostApi.module.invoke('@citadel-app/code', 'repl:stop-container', id);
    ...
    const handleRemoveDockerContainer = async (id: string) => {
        try {
            await __hostApi.module.invoke('@citadel-app/code', 'repl:remove-container', id);
            await refreshDockerContainers();
        } catch (e) {
