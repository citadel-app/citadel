...
import { MainRegistrar, AppSettings, DEFAULT_APP_SETTINGS } from '@citadel-app/core';
...
export class AppSettingsService extends EventEmitter {
    ...
    private registerHandlers() {
        ...
        this.registrar.handle('appSettings.getSettings', async () => this.getSettings());
        this.registrar.handle('appSettings.updateSetting', async (key: string, value: any): Promise<void> => {
            this.updateSetting(key, value);
        });
        this.registrar.handle('appSettings.updateSettings', async (settings: any): Promise<void> => {
