...
${semanticContext}`;
            ...
            const result = await __hostApi.module.invoke('@citadel-app/base', 'ai.generateMetadata', {
                content,
                title: entry.title,
    ...
    const handleApply = async () => {
        ...
        __hostApi.module.invoke('@citadel-app/base', 'ai.indexEntry', entry).catch(e => console.error('[SmartTagsDialog] Proactive index failed', e));
