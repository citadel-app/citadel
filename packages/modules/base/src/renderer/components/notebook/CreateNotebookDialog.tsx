...
import { CitadelDialog, DialogOverlay, DialogContent, DialogTitle, DialogDescription, DialogClose, Popover, PopoverTrigger, PopoverContent } from '@citadel-app/ui';
...
export const CreateNotebookDialog = ({
    ...
    return (
        <CitadelDialog open={open} onOpenChange={onOpenChange}>
            
                <DialogOverlay className="fixed inset-0 bg-background/80 backdrop-blur-sm z-[200] animate-in fade-in duration-300" />
                <DialogContent className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-[95vw] max-w-lg bg-card border border-border/50 shadow-2xl rounded-[2.5rem] p-8 z-[210] animate-in zoom-in-95 fade-in duration-300">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <DialogDescription className="text-xs font-medium text-muted-foreground opacity-60">
