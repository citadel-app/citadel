...
import { MermaidExtension } from '@citadel-app/ui';
...
export interface TiptapWrapperProps {
    ...
    className?: string;
    editable?: boolean;
    onSaveAsset?: (file: File) => Promise<string>;
...
export const TiptapWrapper = ({ content, onChange, className, editable = true, onSaveAsset, basePath }: TiptapWrapperProps) => {
    const editor = useEditor({
        ...
        editorProps: {
            ...
            handlePaste: (view: any, event: any, _slice: any) => {
                ...
                if (images.length > 0 && onSaveAsset) {
                    ...
                    images.forEach(async (item) => {
                        ...
                        if (file) {
                            try {
                                ...
                                const relativePath = await onSaveAsset(file);
