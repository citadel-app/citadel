...
export const TagPicker = ({
    ...
    const availableTags = useMemo(() => {
        ...
        return existingTags.filter(t => !allExcluded.includes(t));
    }, [existingTags, selectedTags, excludeTags]);
                ...
                >
                    <Command className="flex flex-col w-full overflow-hidden">
                        ...
                        <Command.List className="max-h-[200px] overflow-y-auto overflow-x-hidden p-1 custom-scrollbar">
                            ...
                            {search.trim() && !availableTags.some(t => t.toLowerCase() === search.trim().toLowerCase()) && (
                                <>
