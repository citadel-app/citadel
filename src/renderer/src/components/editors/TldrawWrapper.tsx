...
export const TldrawWrapper = ({ className, onMount, persistenceKey }: { className?: string; onMount?: (editor: Editor) => void; persistenceKey?: string }) => {
    ...
    return (
        ...
        >
            ...
            {/* Component Library rendered outside Tldraw context to avoid interaction issues */}
