...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant, theme, size, shape, asChild = false, icon, iconSize, forgedPiece, children, ...props }, ref) => {
        ...
        return (
            ...
            >
                ...
                {icon && <Icon name={icon} size={finalIconSize} className={cn("relative z-10", children ? "mr-2" : "")} />}
