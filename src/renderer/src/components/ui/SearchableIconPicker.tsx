    ...
    return (
        <div className={cn("relative", className)} ref={containerRef}>
            <button
                ...
                className="w-full h-9 flex items-center justify-between px-3 py-2 bg-background border border-input rounded-md hover:border-primary/50 transition-colors text-sm"
            >
                <div className="flex items-center gap-2">
                    <Icon name={value} size={16} className="text-primary" />
                    ...
                    >
                        {visibleIcons.map(iconName => (
                            <button
                                ...
                                className={cn(
                                    "p-2 rounded flex flex-col items-center justify-center hover:bg-muted transition-colors relative group",
                                    value === iconName ? "bg-primary/20 text-primary" : "text-muted-foreground"
                                )}
                            >
