        ...
        <div className={cn("rounded-lg border border-border overflow-hidden flex flex-col h-full", className)}>
            ...
            {activeSolution ? (
                    ...
                    <div className="flex items-center justify-between px-3 py-2 bg-muted/30 border-b border-border">
                        <div className="flex items-center gap-2">
                            ...
                            {activeSolution.path && (
                                <div className="flex items-center gap-1.5 px-2 py-1 bg-muted/50 rounded border border-border/50 max-w-[300px]">
                                    <Icon name="FileCode" size={12} className="text-muted-foreground shrink-0" />
                        ...
                        <div className="flex items-center gap-2">
                            {onRunSolution && (
                                ...
                                >
                                    {isRunning ? <Icon name="Loader2" size={12} className="animate-spin" /> : <Icon name="Play" size={12} />}
                ...
                <div className="flex flex-col items-center justify-center h-[200px] text-muted-foreground">
                    <Icon name="Code" size={32} className="mb-2 opacity-50" />
