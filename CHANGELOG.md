...
* feat: Implement comprehensive welcome and onboarding experience with GitHub multi-account support, workspace setup, and repository management. ([90a2102](https://github.com/iwannabebot/citadel/commit/90a2102e2d26c753075accedbab9ee831bd2c45a))
* feat: introduce a comprehensive welcome page for onboarding, GitHub authentication, and repository management, alongside new branding assets and a build script adjustment. ([49e598a](https://github.com/iwannabebot/citadel/commit/49e598ab535d34e57fcae4af23c1a002a00fccf8))
...
* Add status bar, release workflow, and project README template, updating package description and version. ([1700f6f](https://github.com/iwannabebot/citadel/commit/1700f6f967b9bf7c2c76f130864722d58dd79f8b))
* add vscode settings and update gitignore ([6e2c9fc](https://github.com/iwannabebot/citadel/commit/6e2c9fc938673a86a380a47d799359105e8ce9a4))
* Define macOS entitlements and update the electron-builder configuration path. ([e032f99](https://github.com/iwannabebot/citadel/commit/e032f99eaca0028e3356174ea4c03b83c23faf58))
